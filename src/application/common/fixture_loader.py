...
from src.application.interfaces.services.fixture_loader import (
    IFixtureEntityLoaderService,
)
from src.application.interfaces.services.fixture_loader import IFixtureLoaderService
...
class FixtureDatabaseLoaderService(
    IFixtureDatabaseLoaderService[EntityT],
