...
from src.apps.exception_handlers.landing import InternalServerExceptionHandler
from src.apps.exception_handlers.landing import not_found_exception_handler
from src.config.alchemy import get_alchemy_engine, get_alchemy_config
from src.config.ioc import BasicProvider
from src.config.litestar import get_structlog_config, get_compression_config, get_cors_config
from src.config.plugins import CachePlugin, CLIPlugin
...
def create_app() -> Litestar:
    ...
    litestar_app = Litestar(
        ...
        plugins=[
            SQLAlchemyPlugin(config=get_alchemy_config(engine=alchemy_engine, db_settings=settings.db)),
            StructlogPlugin(config=get_structlog_config(log_settings=settings.log)),
        ...
        exception_handlers={
            ...
            Exception: InternalServerExceptionHandler(debug=settings.app.DEBUG),
        },
