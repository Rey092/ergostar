...
class DdlVersionUnfold(models.Model):
...
class LandingHomePageUnfold(models.Model):
...
class LandingSettingsUnfold(models.Model):
    id = models.BigAutoField(primary_key=True)
...
class LandingSnippetUnfold(models.Model):
    id = models.BigAutoField(primary_key=True)
...
class LandingSolutionUnfold(models.Model):
    id = models.BigAutoField(primary_key=True)
    title = models.CharField(max_length=255)
...
class SubscriptionsPlansUnfold(models.Model):
    id = models.BigAutoField(primary_key=True)
    title = models.CharField(max_length=255)
    subtitle = models.CharField(max_length=255)
